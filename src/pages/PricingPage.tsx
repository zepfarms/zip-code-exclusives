        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              {/* Pricing Card */}
              <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border-2 border-brand-100 relative">
                {/* Popular Badge */}
                ...
                <div className="p-8 md:p-12 hero-gradient text-white text-center">
                  <h2 className="text-3xl md:text-4xl font-bold mb-4">Exclusive Territory Rights</h2>
                  ...
                  <div className="flex items-center justify-center space-x-4">
                    ...
                    <span className="text-lg font-medium">Only 1 Client Per Zip Code</span>
                  </div>
                </div>
                ...
                <div className="p-8 md:p-12 text-center">
                  ...
                  <Link to="/check-availability">
                    <Button className="px-12 py-6 text-xl bg-accent-600 hover:bg-accent-700 shadow-lg transform hover:scale-105 transition-all duration-200">
                ...
                <div className="border-t border-gray-100 p-8 md:p-12 bg-gray-50">
                  <h3 className="text-2xl font-bold text-center mb-8 text-gray-900">Everything Included</h3>
                  <div className="grid md:grid-cols-2 gap-x-16 gap-y-6">
                    <div className="flex items-start">
                      <CheckCircle className="h-6 w-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-semibold text-lg">Unlimited Seller Leads</h4>
                        <p className="text-gray-600 mt-1">No caps, no limits. Get every qualified lead in your zip code.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      <CheckCircle className="h-6 w-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-semibold text-lg">100% Exclusive Territory</h4>
                    ...
                    <div className="flex items-start">
                      <CheckCircle className="h-6 w-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-semibold text-lg">Pre-Qualified Leads</h4>
                        <p className="text-gray-600 mt-1">All leads are verified and pre-screened for motivation.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      <CheckCircle className="h-6 w-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-semibold text-lg">Instant Notifications</h4>
                        <p className="text-gray-600 mt-1">Get leads via email, SMS, or both - your choice.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      <CheckCircle className="h-6 w-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-semibold text-lg">Lead Management Dashboard</h4>
                        <p className="text-gray-600 mt-1">Track, organize, and manage all your leads in one place.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      <CheckCircle className="h-6 w-6 text-green-600 mr-3 flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-semibold text-lg">No Long-Term Contracts</h4>
                        <p className="text-gray-600 mt-1">Month-to-month billing. Cancel anytime with no penalties.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-16 bg-gradient-to-r from-brand-600 to-brand-700 rounded-2xl p-8 md:p-12 text-white text-center">
                <h2 className="text-3xl font-bold mb-4">Why Choose Flat-Rate Pricing?</h2>
              ...
              <div className="mt-16">
                ...
                <div className="space-y-6">
                  <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                    <h3 className="text-xl font-semibold mb-3 text-gray-900">How many leads will I receive each month?</h3>
                    <p className="text-gray-600 text-lg">
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                    <h3 className="text-xl font-semibold mb-3 text-gray-900">What if I want multiple zip codes?</h3>
                    <p className="text-gray-600 text-lg">
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                    <h3 className="text-xl font-semibold mb-3 text-gray-900">Are there any hidden fees or setup costs?</h3>
                    <p className="text-gray-600 text-lg">
                  ...
                  <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                    <h3 className="text-xl font-semibold mb-3 text-gray-900">How quickly can I start receiving leads?</h3>
                    <p className="text-gray-600 text-lg">
              ...
              <div className="mt-16 text-center bg-gray-50 p-8 rounded-2xl">
                <h2 className="text-3xl font-bold mb-4 text-gray-900">Ready to Dominate Your Market?</h2>
                <p className="text-xl text-gray-600 mb-6">
                  Secure your exclusive territory today and start receiving unlimited seller leads with zero competition.
                </p>
                <Link to="/check-availability">
                  <Button className="px-12 py-6 text-xl bg-brand-700 hover:bg-brand-800 shadow-lg">
