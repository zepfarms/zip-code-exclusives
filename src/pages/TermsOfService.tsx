      ...
      <main className="flex-1 py-12 bg-gray-50">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 md:p-8 space-y-6">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-gray-800">3. Subscription and Billing</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-gray-800">4. Refund Policy</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-gray-800">5. Territory Exclusivity</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-gray-800">6. Lead Quality and Quantity</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-gray-800">7. User Responsibilities</h2>
              <p className="text-gray-600">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-semibold text-gray-800">11. Company Information</h2>
              <p className="text-gray-600">
