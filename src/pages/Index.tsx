  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="inline-flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl px-6 py-4 mb-10">
                ...
                <div className="text-left">
                  <div className="font-bold text-lg text-white">Guaranteed 5 leads a month</div>
                  <div className="text-sm text-white/80">Exclusive territory rights in your zip code</div>
                </div>
              </div>
        ...
        {/* Guarantee Section */}
        <section className="py-16 bg-gradient-to-r from-blue-50 to-accent-50 border-y border-blue-100">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                Since our leads don't cost us money to generate, we guarantee you will receive at least 5 qualified seller leads every month in your territory. There's no upper limit to how many leads you can receive - many of our clients get 15-30+ leads per month!
              </p>
              
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-sm border border-blue-100">
                  <CheckCircle2 className="h-12 w-12 text-accent-600 mx-auto mb-4" />
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-200 relative transform hover:scale-105 transition-all duration-300">
                ...
                <div className="mb-10">
                  ...
                  <div className="inline-block bg-gradient-to-r from-blue-100 to-accent-100 text-accent-800 px-6 py-3 rounded-full text-sm font-semibold">
                    Unlimited Leads • Guaranteed 5 Monthly • Cancel Anytime
                  </div>
                </div>
                ...
                <p className="text-lg text-gray-600 mb-10 leading-relaxed">
                  ...
                  No competition, unlimited potential, guaranteed 5 leads monthly minimum.
                </p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                  ...
                  <div className="flex flex-col items-center bg-brand-50 p-4 rounded-xl">
                    ...
                    <span className="text-sm font-medium text-center">Guaranteed 5 Monthly</span>
                  </div>
                  <div className="flex flex-col items-center bg-brand-50 p-4 rounded-xl">
